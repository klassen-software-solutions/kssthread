...
#ifndef kssthread_contract_hpp
#define kssthread_contract_hpp

#include <initializer_list>
#include <string>

namespace kss { namespace thread { namespace _private { namespace contract {
     ...
     */
#   define KSS_EXPR(expr) kss::thread::_private::contract::_private::Expression {(expr), #expr, __PRETTY_FUNCTION__, __FILE__, __LINE__}
